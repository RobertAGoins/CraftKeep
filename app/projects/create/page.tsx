...
export default function CreateProjectPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 p-8 dark:bg-black font-sans flex justify-center">
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg p-8 dark:bg-zinc-900">
        <div className="flex items-center justify-between mb-8">
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Create New Project</h1>
             <Link
                href="/projects"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center justify-center w-full">
              <label htmlFor="image-upload" className="flex flex-col items-center justify-center w-full h-64 border-2 border-zinc-300 border-dashed rounded-lg cursor-pointer bg-zinc-50 dark:hover:bg-zinc-800 dark:bg-zinc-800 hover:bg-zinc-100 dark:border-zinc-600 dark:hover:border-zinc-500">
                {imagePreview ? (
